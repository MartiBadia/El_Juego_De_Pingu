...
public class Pinguino extends Jugador {
    ...
    public void gestionarBatalla(Pinguino p) {
        ...
        //    En caso de empate, nadie retrocede
        int diferencia = bolasThis - bolasP;
        if (diferencia > 0) {
            // this gana, p retrocede 'diferencia' casillas
            p.moverPosicion(-diferencia);
        } else if (diferencia < 0) {
            // p gana, this retrocede 'diferencia' casillas (en valor absoluto)
            this.moverPosicion(diferencia); // diferencia ya es negativo
        }
        // diferencia == 0 -> empate, nadie retrocede
    }
