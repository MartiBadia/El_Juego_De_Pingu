...
public class GestorJugador {
    ...
    /**
     * El jugador usa un ítem de su inventario por nombre.
     * Si no lo tiene, no pasa nada.
     */
    ...
    /**
     * Evento: el pingüino obtiene un dado lento (valores 1-3, probabilidad alta).
     */
    ...
    /**
     * Guerra entre dos pingüinos (Nivel IMPOSSIBLE).
     * Delega en gestionarBatalla del propio Pinguino.
     */
    ...
    /**
     * Interacción foca-pingüino (Nivel IMPOSSIBLE):
     * - Si el pingüino tiene peces → los usa para sobornar a la foca (queda bloqueada 2 turnos).
     * - Si no tiene peces → la foca golpea al pingüino y lo manda al agujero más cercano.
     */
    ...
    /**
     * Nivel INTERMIG: el pingüino pierde un turno (turnosCongelado = 1).
     */
    ...
    /**
     * Nivel INTERMIG: el pingüino pierde un objeto aleatorio del inventario.
     */
    public void pinguinoPierdeItemAleatorio(Pinguino p) {
